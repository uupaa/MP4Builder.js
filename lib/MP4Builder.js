...
function MP4Builder_build(tree) { // @arg MP4BoxTreeObject
    ...
    _overwrite_stco_chunk_offset(streamObject, tree);
...
function _overwrite_stco_chunk_offset(streamObject, // @arg MP4StreamObject
    ...
    var mdat_position       = stream.length - tree["root"]["mdat"]["BoxSize"] + BOX_HEAD_SIZE;
    var chunk_offset_cursor = stream.length - tree["root"]["mdat"]["BoxSize"]
                                            - tree["root"]["free"]["BoxSize"]
                                            - tree["root"]["moov"]["udta"]["BoxSize"]
                                            - stco["BoxSize"] + FULLBOX_HEAD_SIZE + ENTRY_COUNT_SIZE;
